...
public class DictionaryApplication extends JFrame implements ActionListener {
    ...
    DictionaryApplication() {
        ...
        //ImageIcon image = new ImageIcon("C:\\Users\\QUANG\\Downloads\\meme.jpg");
        ...
        apiButton.setBounds(600, 65, 90, 30);
        apiButton.addActionListener(this);
        apiButton.setText("Anh - Việt");
        apiButton.setFocusable(false);
        apiButton.setHorizontalTextPosition(JButton.CENTER);
        apiButton.setVerticalTextPosition(JButton.BOTTOM);
        apiButton.setToolTipText("English to Vietnamese");
        this.add(apiButton);

        apiButton2 = new JButton();
        apiButton2.setBounds(810, 65, 90, 30);
        apiButton2.addActionListener(this);
        apiButton2.setText("Việt - Anh");
        apiButton2.setFocusable(false);
        apiButton2.setHorizontalTextPosition(JButton.CENTER);
        apiButton2.setVerticalTextPosition(JButton.BOTTOM);
        apiButton2.setToolTipText("Vietnames to English");
        this.add(apiButton2);
        ...
        label1.setBackground(new Color(215, 215, 215));
        this.add(label1);

        Label label2;
        label2 = new Label("Nhập từ cần dịch: ");
        label2.setBounds(20, 45, 150, 40);
        label2.setBackground(new Color(215, 215, 215));
        Font font2 = new Font("Times New Roman", Font.ROMAN_BASELINE, 18);
        label2.setFont(font2);
        this.add(label2);

        ImageIcon image6 = new ImageIcon("Icon\\api1.png");
        JLabel apiLabel = new JLabel();
        apiLabel.setBounds(710, 15, 120, 50);
        apiLabel.setIcon(image6);
        apiLabel.setText("Dịch đoạn văn");
        apiLabel.setFocusable(false);
        apiLabel.setHorizontalTextPosition(JLabel.CENTER);
        apiLabel.setVerticalTextPosition(JLabel.BOTTOM);
        this.add(apiLabel);
